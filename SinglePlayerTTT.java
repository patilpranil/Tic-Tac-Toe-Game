...
class TicTacToe1{
	...
	static void insert(int pos,char board[][],char sym) {
		...
		if(sym=='X') {
			SinglePlayerTTT.allp1pos.add(pos);
		}
		else if(sym=='O') {
			SinglePlayerTTT.allp2pos.add(pos);
		}
	}
...
public class SinglePlayerTTT {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			TicTacToe1.insert(playerPos1, board,'X');
			TicTacToe1.showBoard(board);
			TicTacToe1.winner(allp1pos, allp2pos);
			...
			TicTacToe1.insert(playerPos2, board,'O');
			TicTacToe1.showBoard(board);
			TicTacToe1.winner(allp1pos, allp2pos);
